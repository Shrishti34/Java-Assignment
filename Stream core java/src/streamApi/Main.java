...
public class Main {
	public static void main (String [] args) {
		Trader Tom =new Trader("Tom","NeyYork");
		Trader Harry =new Trader("Harry","London");
		Trader Joe =new Trader("Joe","Washington");
		Trader Robert =new Trader("Robert","Paris");
		Trader Priya =new Trader("Priya","Delhi");
		Trader Radha =new Trader("Radha","Pune");
		Trader Krish =new Trader("Krish","Delhi");
		Trader Preete =new Trader("Preete","Mumbai");
		
		//Transaction Record
		List<Transaction> transactions = Arrays.asList(
				new Transaction(Tom,2011,400),
				new Transaction(Harry,2011,1400),
				new Transaction(Joe,2012,800),
				new Transaction(Robert,2011,1400),
				new Transaction(Priya,2012,700),
				new Transaction(Radha,2011,1400),
				new Transaction(Krish,2012,1000),
				new Transaction(Preete,2011,1200)
